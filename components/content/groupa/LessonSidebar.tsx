...
import GeminiChatModal from "@/components/ai/GeminiChatModal2"
          ...
          <CustomAccordion
            ...
            items={[
              ...
              ,{
                ...
                customComponent: (
                  <VideoModalButton
                    iframeUrl="https://www.floopedu.com"
                    title="فيديو تعليمي"
                    trigger={
                      <Button variant="ghost" className="w-full justify-start text-right px-4 py-2 gap-2">
                        <FaPlus className="text-gray-500" />
...

              {
                ...
                customComponent: (
                  <VideoModalButton
                    iframeUrl="https://learninglocker.net"
                    title="فيديو تعليمي"
                    trigger={
                      <Button variant="ghost" className="w-full justify-start text-right px-4 py-2 gap-2">
                        <FaPlus className="text-gray-500" />
